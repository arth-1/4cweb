      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 border-t border-white/10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-muted-foreground text-center md:text-left">
            &copy; {new Date().getFullYear()} 4C NMIMS. All rights reserved. Developed By the Technicals Team of 4C: Arth Agarwal, Krimy Shah, Anunay Gandhi, Arnav Jain, Sylborn Furtado
          </p>
